...
class ShizukuAutomationService : Service() {
    ...
    private suspend fun automationLoop() {
        ...
        if (prefs.accessibilityBatchRunning && !RuntimeOperationCoordinator.ensureOwned(RuntimeOperation.SENDER)) {
            RuntimeDiagnosticStore.append(
                this,
                "UI_OPERATION_COLLISION",
                "Shizuku Sender blocked because ${RuntimeOperationCoordinator.current()?.name ?: "UNKNOWN"} owns WhatsApp UI"
            )
            stopSelf()
            return
        }
    ...
    companion object {
        ...
        private const val VISUAL_PROFILE_PROBE_AFTER_MS = 90L
        private const val VISUAL_PROFILE_PROBE_INTERVAL_MS = 60L
        ...
        private const val DUMP_FAILURE_MIN_INTERVAL_MS = 90L
        private const val UI_TREE_FAILURE_MAX = 4
        ...
        private const val COMMAND_DUMP_KILL_COOLDOWN_MS = 1_000L
